...
export function IOSConfirm({
  ...
  return (
    <AlertDialog.Root open={open} onOpenChange={onOpenChange}>
      <AlertDialog.Portal>
        <AlertDialog.Overlay className="fixed inset-0 z-[340] bg-black/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0" />
        <AlertDialog.Content
          className={cn(
            "fixed left-1/2 top-1/2 z-[341] w-[270px] -translate-x-1/2 -translate-y-1/2",
            "overflow-hidden rounded-2xl border border-white/[0.08] bg-[#1c1c1e]",
