...
export function TicketCard({
  ...
  return (
    <section aria-label="Баланс билетов" className="relative mb-6">
      <div
        className="relative flex h-[140px] overflow-hidden rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/15 via-card/70 to-black shadow-[0_8px_28px_-12px_color-mix(in_oklab,var(--primary)_45%,transparent)]"
      >
        {/* мягкое свечение */}
        <div
          aria-hidden
          className="pointer-events-none absolute -left-8 -top-10 h-40 w-40 rounded-full bg-primary/25 blur-3xl"
        />
        ...
        <div className="relative z-10 flex min-w-0 flex-1 flex-col justify-between p-4">
          ...
          <div className="flex items-end justify-between gap-3">
            <div className="flex items-baseline gap-2">
              <span className="text-[56px] font-semibold leading-none tabular-nums text-foreground">
            ...
            <Link
              to="/club/raffles"
              className="flex shrink-0 items-center gap-1.5 rounded-full bg-primary px-4 py-2 text-[13px] font-semibold text-primary-foreground shadow-[0_6px_16px_-6px_color-mix(in_oklab,var(--primary)_70%,transparent)] transition-all active:scale-95"
            >
        ...
        {/* «корешок» */}
        <div
          className="relative z-10 flex shrink-0 flex-col items-center justify-between py-4"
          style={{ width: STUB_W }}
        >
