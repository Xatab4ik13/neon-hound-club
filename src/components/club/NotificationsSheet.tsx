...
export function NotificationsSheet({ open, onOpenChange }: Props) {
  ...
  return (
    <IOSSheet open={open} onOpenChange={onOpenChange} title="Уведомления">
                ...
                {isIos ? (
                  <ol className="mt-3 space-y-2 text-[13px] text-foreground/90">
                    <li className="flex items-center gap-2">
                      ...
                      Нажмите <Share className="inline h-4 w-4 text-primary" /> «Поделиться» внизу Safari
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="grid h-5 w-5 shrink-0 place-items-center rounded-full bg-white/10 font-mono text-[11px]">
                        2
                      </span>
                      Выберите <Plus className="inline h-4 w-4 text-primary" /> «На экран „Домой"»
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="grid h-5 w-5 shrink-0 place-items-center rounded-full bg-white/10 font-mono text-[11px]">
                        3
