  ...
  return (
    <section className="relative -mt-20 flex min-h-[100svh] items-center overflow-hidden px-6 pb-20 pt-32 md:px-12 md:pb-28 md:pt-36">
      ...
      <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 items-end gap-8 lg:grid-cols-12 lg:items-center lg:gap-4">
        ...
        {raffle ? (
          <div className="relative z-20 order-2 lg:order-1 lg:col-span-7 lg:col-start-4 xl:col-span-6o xl:col-start-5 lg:translate-x-[calc(2.5rem+1cm)] xl:translate-x-[calc(4rem+1cm)] 2xl:translate-x-[calc(5rem+1cm)]">
            <RaffleCloud
              image={image}
              href={raffleHref}
              days={days}
