// Инструкторский таб-бар: копия обычного `MobileTabBar`, но вместо «Гаража»
// стоит «Школа» — это список чатов с учениками (`/club/school-chats`).
// Гараж по-прежнему доступен через кнопку «Ещё».
...
import { MobileMoreSheet } from "@/components/club/MobileMoreSheet";
...
type Tab = {
  label: string;
  href: "/club" | "/club/shop" | "/club/tickets" | "/club/school-chats";
  icon: TabIcon;
  exact?: boolean;
};
...
const TABS: Tab[] = [
  ...
  { label: "Школа", href: "/club/school-chats", icon: PlumpSchool },
];
...
export function InstructorMobileTabBar() {
