    ...
    perks: [
      {
        ...
        detail:
          "AI знает твой байк из гаража, помнит пробег, ТО и проблемы. Можно задать 20 вопросов в месяц — от «что за стук» до «какое масло».",
      },
      {
        icon: MessageSquare,
  ...
  },
  {
    ...
    perks: [
      ...
      },
      {
        ...
        value: "20",
        accent: true,
        label: "AI-генераций картинок в месяц",
        detail:
          "Сгенерировать визуал кастомного байка, ливрею или превью апгрейда — 20 изображений в месяц.",
      },
    ],
  },
  {
