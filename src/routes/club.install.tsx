    ...
    <>
      ...
      <Steps
        ...
        steps={[
          ...
          "Открой с иконки, нажми на колокольчик в правом верхнем углу и подтверди уведомления.",
        ]}
      />
    </>
  );
    ...
    <>
      <Steps
        ...
        steps={[
          ...
          "Открой клуб с иконки, нажми на колокольчик в правом верхнем углу и подтверди уведомления.",
        ]}
