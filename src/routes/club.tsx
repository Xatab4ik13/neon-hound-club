    ...
    <>
      ...
      <div className="border-t border-white/[0.06] p-4">
        <Link
          to="/"
          onClick={onNavigate}
          className="flex items-center gap-2 px-2 py-1.5 font-mono text-[11px] uppercase tracking-[0.18em] text-muted-foreground transition-colors hover:text-foreground"
        >
