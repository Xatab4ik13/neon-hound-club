...
function ClubCartPage() {
  ...
  // Билеты считаем ТОЛЬКО по бонусу, заданному на товаре. Никаких «1 за 200 ₽».
    ...
    return (
      ...
      >
        ...
        <div className="grid place-items-center rounded-2xl border border-dashed border-white/[0.08] bg-card/40 px-6 py-16 text-center">
          ...
          <Link
            to="/club/shop"
            className="mt-5 inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 font-mono text-[12px] font-bold uppercase tracking-wider text-primary-foreground active:scale-95"
          >
            В магазин
          </Link>
        </div>
  ...
  return (
    ...
    >
      ...
      {/* Tickets bonus — только из ticketsBonus на товарах */}
      {ticketsTotal > 0 && (
