...
const POOL: Prize[] = [
  ...
  { id: "t1", title: "1 билет", rarity: "epic", img: imgTicket },
  { id: "t3", title: "3 билета", rarity: "epic", img: imgTicketX3 },
...
function HowItWorks({ season }: { season?: SpinState["season"] }) {
  ...
  const endsLabel = season ? fmt(new Date(new Date(season.endsAt).getTime() - 86_400_000)) : null;
