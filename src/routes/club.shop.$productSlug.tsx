    ...
    <main className="mx-auto w-full max-w-3xl pb-[calc(160px+env(safe-area-inset-bottom))] md:pb-12">
      ...
      <section className="px-4 pt-5">
        ...
        {product.bonusTickets > 0 && (
          <div className="sticker-wiggle mt-4 inline-flex -rotate-2 items-center gap-1.5 rounded-lg border-[2px] border-foreground bg-[#B6FF3C] px-2.5 py-1.5 font-display uppercase  tracking-tight text-black shadow-[3px_3px_0_0_hsl(var(--foreground))]">
