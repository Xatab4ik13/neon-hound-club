...
function SchoolPage() {
  return (
    <main className="relative min-h-screen bg-background pt-32">
      ...
      />
      <div className="relative mx-auto max-w-3xl px-6 py-24 text-center md:px-8">
        <p className="font-mono text-[11px] uppercase tracking-[0.3em] text-primary">
          Скоро
        </p>
        <h1 className="mt-4 font-display text-5xl font-black uppercase italic tracking-tight text-foreground md:text-7xl">
          Школа Hellhound
        </h1>
